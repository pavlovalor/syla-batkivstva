...
export function ResultsScreen({ assessment, answers, onRetake }: ResultsScreenProps) {
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 py-6 sm:px-6 sm:py-12 bg-bg-primary">
      <div className="w-full max-w-2xl text-center">
        {/* Success checkmark */}
        <div className="w-14 h-14 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-8 rounded-full bg-linear-to-br from-success-500 to-success-700 flex items-center justify-center">
          <svg
