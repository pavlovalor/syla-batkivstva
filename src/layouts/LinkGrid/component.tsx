import { Blok, MediaAsset, CommonLayoutMetaProps } from '~/storyblok/types';
...
export type LinkGridLayoutProps = Blok<CommonLayoutMetaProps & {
  avatar: MediaAsset,
  username: string,
  title: string,
  url: string,
...
export const LinkGridLayout: React.FC<LinkGridLayoutProps> = ({ blok }) => (
